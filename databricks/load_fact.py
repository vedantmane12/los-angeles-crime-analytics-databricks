...
#     Foreign Keys:
#     - date_occurred_key → dim_date
#     - date_reported_key → dim_date
#     - time_occurred_key → dim_time
#     - location_key → dim_location
#     - crime_type_key → dim_crime_type
#     - victim_demographic_key → dim_victim_demographics
#     - premise_key → dim_premise
#     - weapon_key → dim_weapon
#     - status_key → dim_status
    
#     Measures:
#     - days_to_report (numeric)
#     - crime_count (always 1, for aggregation)
#     - Boolean flags (is_weapon_involved, is_arrested, etc.)
#     """
    
#     # Read from Silver layer (streaming)
#     df_silver = pl.read_stream("lacrime_incidents_silver")
    
#     # Read all dimensions (batch reads using dlt.read for materialized views)
#     dim_date = dlt.read("dim_date")
#     dim_time = dlt.read("dim_time")
    
#     # Read streaming dimensions
#     dim_location = pl.read_stream("dim_location")
#     dim_crime_type = pl.read_stream("dim_crime_type")
#     dim_victim = pl.read_stream("dim_victim_demographics")
#     dim_premise = pl.read_stream("dim_premise")
#     dim_weapon = pl.read_stream("dim_weapon")
#     dim_status = pl.read_stream("dim_status")
...
#         monotonically_increasing_id().cast("long").alias("incident_key"),
...
#         col("created_by").alias("silver_created_by"),
#         lit("fact_crime_incidents_flow").alias("gold_created_by")
#     )
